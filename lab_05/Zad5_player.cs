...
public class Zad5Player : MonoBehaviour
{
    ...
    // Zmienne potrzebne do obsługi potrójnego skoku
    public bool should_tripple_jump = false;
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Jump") && groundedPlayer && !should_tripple_jump)
        {
            playerVelocity.y += Mathf.Sqrt(jumpHeight * -3.0f * gravityValue);
            Debug.Log("Basic jump");
        }
        else if (should_tripple_jump && groundedPlayer)
        {
